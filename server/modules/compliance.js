...
export const REPORT_TARGET_KINDS = new Set(["user", "book", "review", "excerpt", "event", "occasion", "publisher_news", "shelf", "chat", "comment", "book_note", "marketplace_listing", "marketplace_conversation", "partner", "admin_action", "interface"]);
