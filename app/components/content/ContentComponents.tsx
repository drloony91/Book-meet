...
export function MaterialPreviewCard({ item, index = 0, owner, book, likesCount, commentsCount, kindLabel, onOpen, onOpenUser, onOpenAuthor, onOpenBook }: { item: ReadingItem; index?: number; owner?: DemoUser; book?: LibraryBook | AuthorBook; likesCount?: number; commentsCount?: number; kindLabel?: string; onOpen: () => void; onOpenUser: (id: number) => void; onOpenAuthor?: () => void; onOpenBook?: () => void }) {
