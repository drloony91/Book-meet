      ...
      <section className="public-profile-modal" role="dialog" aria-modal="true" aria-labelledby="public-profile-title" onMouseDown={(event) => event.stopPropagation()}>
        ...
        <div className="public-profile-body">
          ...
          <nav className="public-profile-tabs" aria-label={t("nav.profile")}>
            ...
            {tabVisible("wishlist") && user.profile.canViewWishlist && (user.profile.type === "Читатель" || user.profile.type === "Блогер") && <button className={activeTab === "wishlist" ? "active" : ""} type="button" onClick={() => setActiveTab("wishlist")}>{t("wishlist.title")} <span>{profileWishBooks.length}</span></button>}
