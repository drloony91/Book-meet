...
import { ReadingPresencePreference } from "../components/books/ReadingPresencePreference";
          ...
          {activeTab === "main" && <>
            {editing ? (
              <form className="profile-form" noValidate onSubmit={save}>
                ...
                {["Читатель", "Писатель", "Блогер"].includes(profile.type) && <ReadingPresencePreference />}
