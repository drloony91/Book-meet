...
export function useBookMeetController() {
  ...
  return (
    <div className={`app-shell ${mobileNavigationOpen ? "mobile-navigation-open" : ""} ${view === "chat" ? "mobile-chat-route" : ""} ${view === "search" || view === "chat" || view === "notifications" ? "mobile-header-hidden" : ""} ${view === "chat" && currentRoute.overlay?.kind === "chat" && selectedFriend ? "mobile-chat-dialog-active" : ""}`}>
